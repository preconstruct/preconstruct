...
Hello and welcome! This folder has been automatically generated by `@changesets/cli`, a build tool that works with `bolt` to help you release packages from a multi-package repo. You can find the full documentation for it [here](https://www.npmjs.com/package/@changesets/cli)
...
Changesets are generated by the `pnpm changeset` or `npx changeset` command. As long as you are following a changeset release flow, you shouldn't have any problems.
