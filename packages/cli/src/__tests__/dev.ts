...
test(".d.ts file with default export", async () => {
  ...
  expect(await getDist(dir)).toMatchInlineSnapshot(`
    ...
    ⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯ dist/typescript.cjs.d.ts.map ⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯
    {"version":3,"file":"typescript.cjs.d.ts","sourceRoot":"","sources":["../src/index.js"],"names":[],"mappings":"AAAA"}
    ...
    // this bit of code imports the require hook and registers it
    let unregister = require("../../../../../../../../Users/emma/projects/preconstruct/packages/hook").___internalHook(typeof __dirname === 'undefined' ? undefined : __dirname, "..", "..");
