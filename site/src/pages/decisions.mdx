...
- Support complex use cases with minimal configuration
- Go beyond just building your project but solving problems that people encounter when building a project
